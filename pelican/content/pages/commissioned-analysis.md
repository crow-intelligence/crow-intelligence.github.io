...
Status: published
Summary: The build arm of the same practice: analysis, visualisation and data storytelling — from a single interactive chart to a scrollable data essay.
Og_image: /images/social-preview/commissioned-analysis.png

Sometimes the finding is not the deliverable. Sometimes the deliverable is the
thing people can look at, argue with, and act on.

This is the build side of the same practice. Where the
[language analysis](/services/language-insight.html) ends in a decision, a
commission ends in an artefact — a chart, a scrollable essay, a microsite that
holds an argument.

## What a commission looks like

A commission might be a single interactive chart, a scrollable data essay, or a
standalone microsite. We handle it end to end:

- **The analysis.** Cleaning, modelling, and interrogating the data —
  computational text analysis, semantic networks, temporal change, personality
  and rhetoric, geographic and network structure.
- **The narrative.** Finding the argument the data can actually support, and
  the honest shape of the uncertainty around it.
- **The build.** Designing and engineering the final artefact, from a
  publication-ready figure to a fully interactive web piece.

## How we work

We are candid early about what the data can and cannot show — before the design
work begins, not after. We scope each commission to a clear deliverable and a
clear question, and we build on tooling we maintain ourselves, so the methods
behind a piece are transparent and reproducible.

## What the tooling actually does

The libraries are not a portfolio flourish; they are what the work runs on, and
each one exists because an analysis needed it.
...
dataset or a result that matters and is not yet legible to the people who need
to act on it.

*Need to know what your text data is telling you before deciding what to build?
That is [Actionable Insight from Language Data](/services/language-insight.html).*
...
<script type="application/ld+json">
{
  ...
  "@type": "Service",
  "@id": "https://crowintelligence.org/services/commissioned-analysis.html#service",
